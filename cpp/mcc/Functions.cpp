...
const float RADTOREG = 57.32484076f; //!< Radians to degrees
const float REGTORAD = 0.017453293f; //!< Radians to degrees
const float PI = 3.14159265f; //!< Value of PI
const float PI2 = 6.283185307f; //!< Value of PI*2
...
float computeInnerAngle(int x11, int y11, int x12, int y12, int x21, int y21, int x22, int y22) {
	...
	float dx21 = static_cast<float>(x2 - x1);
	float dx31 = static_cast<float>(x3 - x1);
	float dy21 = static_cast<float>(y2 - y1);
	float dy31 = static_cast<float>(y3 - y1);
